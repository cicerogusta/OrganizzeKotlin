...
allOf(withId(R.id.mi_button_next), withContentDescription("Next"),
childAtPosition(
allOf(withId(R.id.mi_frame),
childAtPosition(
...
allOf(withId(R.id.buttonCadastrar), withText("Cadastre-se"),
childAtPosition(
childAtPosition(
...
allOf(withId(R.id.buttonCadastrar), withText("Cadastrar"),
childAtPosition(
childAtPosition(
withId(android.R.id.content),
0),
...
allOf(withId(R.id.textViewLogin), withText("Já tenho conta"),
childAtPosition(
childAtPosition(
withId(R.id.mi_pager),
1),
...
allOf(withId(R.id.editEmailLogin),
childAtPosition(
childAtPosition(
withId(android.R.id.content),
0),
...
allOf(withId(R.id.editSenhaLogin),
childAtPosition(
childAtPosition(
withId(android.R.id.content),
0),
